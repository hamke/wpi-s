if ( window.location.hostname == 'localhost' ) {
  var url = 'http://localhost:8080/i/wp-kr/' + 'store-item/kr/store/data/auto-money-blog-fb/';
  // console.log( 'Hostname : localhost' );
} else {
  var url = 'https://www.wp-kr.com/' + 'store-item/kr/store/data/auto-money-blog-fb/';
